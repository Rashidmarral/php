...
<section class="section" style="padding-top:56px;">
  <div class="container" style="max-width:760px;">
    ...
    <?php else: ?>
      ...
      <p style="color:var(--muted);">BuildXact Saudi provides construction estimating, project, and invoicing software on a subscription basis, billed monthly or yearly per the plan you choose at <a href="/pricing">/pricing</a>. Features available to your account depend on your subscribed plan.</p>
      ...
      <p style="color:var(--muted);">You retain ownership of the data you enter into the platform (clients, projects, estimates, invoices). We process it only to provide the service, as described in our <a href="/privacy">Privacy Policy</a>.</p>
