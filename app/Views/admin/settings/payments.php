...
<form method="post" action="/admin/settings/payments" class="card" style="max-width:680px;margin-bottom:20px;">
  ...
  <div class="form-row">
    <div class="form-group"><label><?= t('admin.settings.bank_name') ?></label><input type="text" name="bank_name" value="<?= View::e($settings['bank_name'] ?? '') ?>"></div>
    <div class="form-group"><label><?= t('admin.settings.account_name') ?></label><input type="text" name="bank_account_name" value="<?= View::e($settings['bank_account_name'] ?? '') ?>"></div>
  </div>
  <div class="form-row">
    <div class="form-group"><label><?= t('admin.settings.iban') ?></label><input type="text" name="bank_iban" value="<?= View::e($settings['bank_iban'] ?? '') ?>" placeholder="SA00 0000 0000 0000 0000 0000"></div>
    <div class="form-group"><label><?= t('admin.settings.account_number') ?></label><input type="text" name="bank_account_number" value="<?= View::e($settings['bank_account_number'] ?? '') ?>"></div>
  </div>
  ...
  <div class="form-group"><label><?= t('admin.settings.publishable_key') ?></label><input type="text" name="moyasar_publishable_key" value="<?= View::e($settings['moyasar_publishable_key'] ?? '') ?>" placeholder="pk_live_..."></div>
