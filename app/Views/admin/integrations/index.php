...
<div class="grid grid-2">
  ...
  <div class="card">
    <div style="display:flex;justify-content:space-between;align-items:start;">
      ...
      <span class="badge badge-<?= $moyasarConfigured ? 'green' : 'gray' ?>"><?= $moyasarConfigured ? 'Connected' : 'Not connected' ?></span>
    </div>
    ...
    <a href="/admin/settings/payments" class="btn btn-sm btn-outline">Configure →</a>
  </div>

  <div class="card">
    <div style="display:flex;justify-content:space-between;align-items:start;">
      <h3>🏦 Bank transfer</h3>
      <span class="badge badge-<?= $bankTransferEnabled ? 'green' : 'gray' ?>"><?= $bankTransferEnabled ? 'Enabled' : 'Disabled' ?></span>
    </div>
  ...
  <div class="card">
    <div style="display:flex;justify-content:space-between;align-items:start;">
      ...
      <span class="badge badge-<?= $whatsappConfigured ? 'green' : 'gray' ?>"><?= $whatsappConfigured ? 'Connected' : 'Not connected' ?></span>
    </div>
    ...
    <a href="/admin/settings/notifications" class="btn btn-sm btn-outline">Configure →</a>
  </div>

  <div class="card">
    <div style="display:flex;justify-content:space-between;align-items:start;">
      <h3>✉️ SMTP email</h3>
      <span class="badge badge-<?= $smtpConfigured ? 'green' : 'gray' ?>"><?= $smtpConfigured ? 'Connected' : 'Not connected' ?></span>
    </div>
    ...
    <a href="/admin/settings/email" class="btn btn-sm btn-outline">Configure →</a>
  </div>

  <div class="card">
    <div style="display:flex;justify-content:space-between;align-items:start;">
      <h3>🧾 ZATCA e-invoicing</h3>
      <span class="badge badge-blue">Per company</span>
    </div>
    ...
    <a href="/admin/companies" class="btn btn-sm btn-outline">Go to Companies →</a>
  </div>
