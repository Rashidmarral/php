...
<div class="kpi-grid" style="grid-template-columns:repeat(2,220px);">
  <div class="kpi"><div class="label"><?= t('user.reports.outstanding_retention') ?></div><div class="value"><?= View::money($outstanding) ?></div></div>
  <div class="kpi"><div class="label"><?= t('user.reports.released') ?></div><div class="value"><?= View::money($released) ?></div></div>
</div>
      ...
      <tr>
        ...
        <td>
          <?php if ($r['retention_released']): ?>
            <span class="badge badge-green"><?= t('user.reports.released') ?> <?= View::e($r['retention_released_at']) ?></span>
          <?php else: ?>
