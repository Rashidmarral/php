...
<title>@hasSection('title')@yield('title') · @endif Admin · {{ \App\Models\Setting::siteName() }}</title>
...
<div class="app-shell">
  <aside class="sidebar">
    ...
    <nav>
      ...
      <a href="{{ url('/admin/material-library') }}" class="{{ request()->is('admin/material-library*') ? 'active' : '' }}">📦 {{ t('aside.material_library') }}</a>
