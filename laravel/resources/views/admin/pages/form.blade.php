...
<form method="post" action="<?= $isEdit ? '/admin/pages/' . $page['id'] : '/admin/pages' ?>">
  ...
  <div class="card" style="margin-bottom:20px;">
    ...
    <div class="form-row">
      ...
      <div class="form-group">
        ...
        <input type="number" name="nav_order" value="<?= e((string)($page['nav_order'] ?? 0)) ?>">
      </div>
    </div>
    <div class="form-row">
    ...
    <div class="form-row">
      <div class="form-group"><label><?= t('admin.pages.nav_label_en') ?></label><input type="text" name="nav_label_en" value="<?= e($page['nav_label_en'] ?? '') ?>"></div>
      <div class="form-group"><label><?= t('admin.pages.nav_label_ar') ?></label><input type="text" name="nav_label_ar" value="<?= e($page['nav_label_ar'] ?? '') ?>" dir="rtl"></div>
    </div>
  </div>
  ...
  <div class="grid grid-2" style="gap:20px;margin-bottom:20px;">
    <div class="card">
      ...
      <div class="form-group"><label><?= t('common.title') ?></label><input type="text" name="title_en" value="<?= e($page['title_en'] ?? '') ?>" required></div>
      <div class="form-group"><label><?= t('admin.pages.meta_description') ?></label><input type="text" name="meta_description_en" value="<?= e($page['meta_description_en'] ?? '') ?>"></div>
      <div class="form-group">
    ...
    <div class="card">
      ...
      <div class="form-group"><label><?= t('common.title') ?></label><input type="text" name="title_ar" value="<?= e($page['title_ar'] ?? '') ?>" dir="rtl" required></div>
      <div class="form-group"><label><?= t('admin.pages.meta_description') ?></label><input type="text" name="meta_description_ar" value="<?= e($page['meta_description_ar'] ?? '') ?>" dir="rtl"></div>
      <div class="form-group">
        <label><?= t('admin.pages.body_html') ?></label>
        <textarea name="content_ar" rows="16" dir="rtl" style="font-family:monospace;font-size:13px;"><?= e($page['content_ar'] ?? '') ?></textarea>
      </div>
    </div>
  </div>
  ...
  <?php if ($isEdit): ?>
    <a href="/p/<?= e($page['slug']) ?>" target="_blank" class="btn btn-light"><?= t('admin.pages.preview') ?></a>
  <?php endif; ?>
</form>
