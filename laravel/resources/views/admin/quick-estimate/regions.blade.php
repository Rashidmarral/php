...
<table class="data">
  ...
  <?php foreach ($regions as $r): $fid = 'region-' . $r['id']; ?>
    <form id="<?= $fid ?>" method="post" action="/admin/quick-estimate/regions/<?= $r['id'] ?>"><?= csrf_field() ?></form>
    <tr>
      <td><input form="<?= $fid ?>" type="text" name="name_en" value="<?= e($r['name_en']) ?>" style="min-width:140px;"></td>
      <td><input form="<?= $fid ?>" type="text" name="name_ar" value="<?= e($r['name_ar']) ?>" dir="rtl" style="min-width:140px;"></td>
      <td><input form="<?= $fid ?>" type="number" step="0.01" name="price_per_sqm" value="<?= e((string)$r['price_per_sqm']) ?>" style="width:90px;"></td>
      <td><input form="<?= $fid ?>" type="number" step="0.01" name="multiplier" value="<?= e((string)$r['multiplier']) ?>" style="width:80px;"></td>
      <td><input form="<?= $fid ?>" type="number" name="sort_order" value="<?= e((string)$r['sort_order']) ?>" style="width:70px;"></td>
