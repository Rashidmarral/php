...
<?php else: ?>
  <table class="data">
    ...
    <?php foreach ($leads as $lead): ?>
      <tr>
        <td class="help-text"><?= e($lead['created_at']) ?></td>
        <td><?= e($lead['project_name'] ?: '—') ?></td>
        <td>
          <?= e($lead['contact_name'] ?: '—') ?>
          <?php if ($lead['contact_email']): ?><div class="help-text"><?= e($lead['contact_email']) ?></div><?php endif; ?>
          <?php if ($lead['contact_phone']): ?><div class="help-text"><?= e($lead['contact_phone']) ?></div><?php endif; ?>
        </td>
        <td><?= e($lead['region_name'] ?? '—') ?></td>
        <td><?= e((string)$lead['total_area']) ?> m²</td>
        <td><?= money((float)$lead['total']) ?></td>
        <td>
