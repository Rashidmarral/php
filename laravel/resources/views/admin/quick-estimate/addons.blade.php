    ...
    <div class="form-row">
      ...
      <div class="form-group">
        ...
        <select name="unit_type">
          <option value="sqm"><?= t('admin.qe.per_sqm') ?></option>
          <option value="ton"><?= t('admin.qe.per_ton') ?></option>
          <option value="unit"><?= t('admin.qe.per_unit') ?></option>
        </select>
      </div>
    </div>
    <div class="form-row">
...
<table class="data">
  <thead><tr><th><?= t('admin.templates.name_en_col') ?></th><th><?= t('admin.templates.name_ar_col') ?></th><th><?= t('admin.qe.unit_price') ?></th><th><?= t('common.unit') ?></th><th><?= t('admin.qe.pro') ?></th><th><?= t('common.sort_order') ?></th><th><?= t('common.active') ?></th><th></th></tr></thead>
  <tbody>
