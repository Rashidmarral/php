...
@if (!$enabled)
  <div class="card" style="max-width:560px;">
    ...
    <form method="post" action="/admin/security/enable" style="margin-top:16px;">
      @csrf
      <div class="form-group">
...
@else
  <div class="card" style="max-width:560px;">
    ...
    <details style="margin:16px 0;">
      ...
      <form method="post" action="/admin/security/recovery-codes" style="margin-top:12px;">
        @csrf
    ...
    <details style="margin:16px 0;">
      ...
      <form method="post" action="/admin/security/disable" style="margin-top:12px;">
        @csrf
