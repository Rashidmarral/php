...
Route::prefix('app')->middleware('company.user')->group(function () {
    ...
    Route::get('/projects/{id}/subcontracts', [SubcontractController::class, 'index']);
    Route::get('/projects/{id}/subcontracts/create', [SubcontractController::class, 'create']);
    Route::post('/projects/{id}/subcontracts', [SubcontractController::class, 'store']);
    Route::get('/subcontracts/{id}', [SubcontractController::class, 'show']);
    Route::get('/subcontracts/{id}/edit', [SubcontractController::class, 'edit']);
    Route::post('/subcontracts/{id}', [SubcontractController::class, 'update']);
    Route::post('/subcontracts/{id}/delete', [SubcontractController::class, 'destroy']);
    Route::get('/subcontracts/{id}/payments/create', [SubcontractPaymentController::class, 'create']);
    Route::post('/subcontracts/{id}/payments', [SubcontractPaymentController::class, 'store']);
    Route::get('/subcontract-payments/{id}', [SubcontractPaymentController::class, 'show']);
    Route::get('/subcontract-payments/{id}/edit', [SubcontractPaymentController::class, 'edit']);
